...
public class ConeHighComparatorTest {

    @Test
    public void testCompare() {
        List<Cone> list = new ArrayList<>();
        list.add(new Cone(new Point(1,1,1), 10,7));
        list.add(new Cone(new Point(1,1,1), 16,7));
        list.add(new Cone(new Point(1,1,1), 6,7));

        List<Cone> finalList = new ArrayList<>();
        finalList.add(new Cone(new Point(1,1,1), 6,7));
        finalList.add(new Cone(new Point(1,1,1), 10,7));
        finalList.add(new Cone(new Point(1,1,1), 16,7));

        ConeRepository repository = new ConeRepository(list);
        repository.sort(new ConeHighComparator());
